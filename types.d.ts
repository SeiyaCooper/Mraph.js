...
declare module "mobjects/2D/Point2D" {
...
declare module "utils/utils" {
     ...
     * @returns {Point2D}
     */
    export function tryIntoPoint2D(source: number[] | Point2D | Point3D | Vector): Point2D;
    /**
     * Try to convert into a Point3D from a source
     * @param {number[] | Point2D | Point3D | Vector} source
     * @returns {Point3D}
     */
    export function tryIntoPoint3D(source: number[] | Point2D | Point3D | Vector): Point3D;
    import Point2D from "mobjects/2D/Point2D";
...
declare module "mobjects/2D/Line" {
    export default class Line extends Mobject2D {
         ...
         * @returns {Line}
         */
        constructor(start?: Point3D | Point2D | number[] | Vector, end?: Point3D | Point2D | number[] | Vector);
        ...
        set vector(vec: import("mraph").Vector);
        get vector(): import("mraph").Vector;
